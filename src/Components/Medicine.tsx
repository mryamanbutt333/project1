...
const data = [
    ...
    },
    {
        ...
        desc: "Medicine is the field focused on diagnosing, treating, and preventing health issues, while a medical store is a retail outlet that provides medications, health supplies, and medical equipment to support healthcare needs..",
        img: "/project-3.png",
        tags: ["treatment"],
